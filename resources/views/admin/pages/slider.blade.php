							...
							<div class="card-content collapse show">
								<div class="card-body">
									...
									{{ csrf_field() }}
										<div class="form-body">
											<div class="row">
												<label class="col-md-4 text-right">Frist Title</label>
												<div class="col-md-8">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="First Title" @if(isset($edit))
										value="{{$edit->title_one}}" @endif name="title_one">
													</div>
												</div>
											</div>
											<div class="row">
												<label class="col-md-4 text-right">Second Title</label>
												<div class="col-md-8">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="Second Title" @if(isset($edit))
										value="{{$edit->title_two}}" @endif name="title_two">
													</div>
												</div>
											</div>
											<div class="row">
												<label class="col-md-4 text-right">Third Title</label>
												<div class="col-md-8">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="Third Title" @if(isset($edit))
										value="{{$edit->title_three}}" @endif name="title_three">
													</div>
												</div>
											</div>
											<div class="row">
										...
										<tbody>
											...
											<tr>
												...
												<td>
						                            ...
						                            <a href="{{url('admin-site/slider/edit/'.$row->id)}}" title="Edit" class="btn btn-icon btn-outline-primary"><i class="fa fa-pencil-square-o"></i></a>
                                        			<a  href="{{url('admin-site/slider/delete/'.$row->id)}}" title="Delete" class="btn btn-icon btn-outline-danger"><i class="ft-trash-2"></i></a>
