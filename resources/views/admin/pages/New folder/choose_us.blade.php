					...
					<div class="col-xl-6 col-lg-12 offset-md-3">
						<div class="card">
							<div class="card-header">
								@if(isset($edit))
								 	<h4 class="card-title">Edit Choose Us</h4>
								@else
									<h4 class="card-title">Add Choose Us</h4>
								@endif
							...
							<div class="card-content collapse show">
								<div class="card-body">
									...
									@if(isset($edit))
										action="{{url('admin-site/choose/modify/'.$edit->id)}}"
									@else
										action="{{url('admin-site/choose/save')}}"
									@endif>
									{{ csrf_field() }}
										<div class="form-body">
											<div class="row">
										...
										<tbody>
											...
											<tr>
												...
												<td>
						                            ...
						                            <a href="{{url('admin-site/choose/edit/'.$row->id)}}" title="Edit" class="btn btn-icon btn-outline-primary"><i class="fa fa-pencil-square-o"></i></a>
                                        			<a  href="{{url('admin-site/choose/delete/'.$row->id)}}" title="Delete" class="btn btn-icon btn-outline-danger"><i class="ft-trash-2"></i></a>
