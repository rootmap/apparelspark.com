...
@section('title','Server Link')
@section('breadcrumb','Server Link')
					...
					<div class="col-xl-6 col-lg-12 offset-md-3">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Server Link</h4>
							...
							<div class="card-content collapse show">
								<div class="card-body">
									...
									@if(isset($edit))
										action="{{url('admin-site/server/modify/'.$edit->id)}}"
									@else
										action="{{url('admin-site/server/save')}}"
									@endif>
									{{ csrf_field() }}
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-8">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="Name" name="name" @if(isset($edit))
										value="{{$edit->name}}" @endif>
													</div>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-8">
													<div class="form-group">
														<input type="text" class="form-control" placeholder="Server Link" name="link" @if(isset($edit))
										value="{{$edit->link}}" @endif>
													</div>
												</div>
											</div>
			...
			<section id="base-style">
				<div class="row">
					<div class="col-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Server Link List</h4>
										...
										<tbody>
											...
											<tr>
												...
												<td>
						                            ...
						                            <a href="{{url('admin-site/server/edit/'.$row->id)}}" title="Edit" class="btn btn-icon btn-outline-primary"><i class="fa fa-pencil-square-o"></i></a>
                                        			<a  href="{{url('admin-site/server/delete/'.$row->id)}}" title="Delete" class="btn btn-icon btn-outline-danger"><i class="ft-trash-2"></i></a>
