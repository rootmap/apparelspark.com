						...
						<div class="card">
							...
							<div class="card-content collapse show">
								<div class="card-body">
									...
									@if(isset($edit))
										action="{{url('admin-site/category/modify/'.$edit->id)}}"
									@else
										action="{{url('admin-site/category/save')}}"
									@endif>
									{{ csrf_field() }}
										<div class="form-body">
											<div class="row">
											...
											<div class="row">
												...
												<div class="col-md-8">
													<div class="form-group">
														...
														@if(isset($edit))
														@if(!empty($edit->image))
															<img style="margin-top: 10px;"  width="150" src="{{url('upload/category/'.$edit->image)}}"  />
														@endif
										...
										<tbody>
											...
											<tr>
												...
												<td>
						                            ...
						                            <a href="{{url('admin-site/category/edit/'.$row->id)}}" title="Edit" class="btn btn-icon btn-outline-primary"><i class="fa fa-pencil-square-o"></i></a>
                                        			<a  href="{{url('admin-site/category/delete/'.$row->id)}}" title="Delete" class="btn btn-icon btn-outline-danger"><i class="ft-trash-2"></i></a>
