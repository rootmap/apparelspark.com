...
*/
    ...
    {
        return "Dear ".$name.", Thank you for shopping at ".$sitename.". We hope you will enjoy your new purchase! We have included your order receipt and delivery details below:";
    }
    ...
    {
        return "Dear ".$name.", Thank you for table reservation at ".$sitename.". We will get back to you as soon as possible! We have included your Reservation info and datetime details below:";
    }
